...
for el in count(2):
    if el > 10:
        ...
        my_list.append(el)   # это не совсем по задаче итог, но я решил, что это более полезный результат

print(my_list)

# использую предыдущий результат для следующей задачи. Итог так же вывожу в списк, вместо просто распечатки
